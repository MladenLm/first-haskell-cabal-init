...
/* package first-haskell-cabal-init-0.1.0.0 */
#ifndef VERSION_first_haskell_cabal_init
#define VERSION_first_haskell_cabal_init "0.1.0.0"
#endif /* VERSION_first_haskell_cabal_init */
#ifndef MIN_VERSION_first_haskell_cabal_init
#define MIN_VERSION_first_haskell_cabal_init(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_first_haskell_cabal_init */
...
#define CURRENT_PACKAGE_KEY "first-haskell-cabal-init-0.1.0.0-BUWWggYxiYTD2786KOEzWd"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "first-haskell-cabal-init-0.1.0.0-BUWWggYxiYTD2786KOEzWd"
